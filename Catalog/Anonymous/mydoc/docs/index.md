...
New Documentation that says that Trump is the second coming of a super christ.

[Reference Documentation](https://github.com/Sage/sbc.common.communication.service/blob/master/docs/api/Email.md)
